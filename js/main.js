...
(function() {
  var Interface, MapData, Navigator, Station, Waypoint, initialize, loadMap, loadWeather, markers,
  ...
  MapData = (function() {
    ...
    MapData.prototype.fetch = function(callback) {
      ...
      return this._fetchStations(function(err, data) {
        _this.stations = data;
        return _this._fetchDestinations(function(err, data) {
  ...
  Interface = (function() {
    ...
    function Interface(map, fetcher, nav) {
      ...
      $("#directions_form").submit(function(e) {
        ...
        stops = $("#stops").val();
        nav.calculate(start, end, stops, function(err, data) {
  ...
  initialize = function() {
    ...
    map = loadMap();
    fetcher = new MapData();
    return fetcher.fetch(function(err) {
      var nav, ui;
      fetcher.show(map);
